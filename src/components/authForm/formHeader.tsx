...
type FormHeaderProps = {
  ...
  rightHeading: string;
  subHeading: string;
  leftHeaderTranslateX: Animated.AnimatedInterpolation<string | number>;
  rightHeaderTranslateY: Animated.AnimatedInterpolation<string | number>;
  rightHeaderOpacity: Animated.AnimatedInterpolation<string | number>;
};
